...
__all__ = ['cifar10_dataloaders', 'cifar100_dataloaders', 'cifar10_dataloaders_no_val', 'cifar100_dataloaders_no_val','fast_cifar10_dataloaders']
...
def fast_cifar10_dataloaders(batch_size=128, data_dir='datasets/cifar10', num_workers=2,class_to_replace: int = None,num_indexes_to_replace = None,indexes_to_replace = None, seed: int = 1, only_mark: bool = False,shuffle = True):
    ...
    loaders,_ = make_dataloaders_cifar(data_dir+'/cifar_train.beton', data_dir+'/cifar_val.beton',data_dir+'/cifar_test.beton', batch_size=batch_size, num_workers=num_workers)
