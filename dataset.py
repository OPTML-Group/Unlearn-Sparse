...
__all__ = ['cifar10_dataloaders', 'cifar100_dataloaders', 'cifar10_dataloaders_no_val', 'cifar100_dataloaders_no_val']
...
def cifar10_dataloaders(batch_size=128, data_dir='datasets/cifar10', num_workers=2,class_to_replace: int = None,num_indexes_to_replace: int = None,indexes_to_replace = None, seed: int = 1, only_mark: bool = False,shuffle = True):
    ...
    train_loader = DataLoader(train_set, batch_size=batch_size, shuffle=True, worker_init_fn=_init_fn if seed is not None else None, **loader_args)
    val_loader = DataLoader(valid_set, batch_size=batch_size, shuffle=False, worker_init_fn=_init_fn if seed is not None else None, **loader_args)
    test_loader = DataLoader(test_set, batch_size=batch_size, shuffle=False, worker_init_fn=_init_fn if seed is not None else None, **loader_args)
